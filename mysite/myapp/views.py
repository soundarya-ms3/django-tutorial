...
# classs based view for above product view(ListView)
...
# classs based view for above product_detail view(DetailView)
...
# classs based view for above add_product view(CreateView)
...
def update_product(request,id):
 ...
 #classs based view for above update_product view(UpdateView)
...
#classs based view for above delete_product view(DeleteView)
